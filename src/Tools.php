...
//            $body = "<bpeDadosMsgZip xmlns=\"$this->urlNamespace\">$gzdata</bpeDadosMsgZip>";
//            $method = $this->urlMethod."Zip";
//            $parameters = ['bpeDadosMsgZip' => $gzdata];
//            $body = "<bpeDadosMsgZip xmlns=\"$this->urlNamespace\">$gzdata</bpeDadosMsgZip>";
//        }
    ...
    public function sefazConsultaRecibo($recibo, $tpAmb = null)
    {
        ...
        if ($this->urlService == '') {
            $msg = "A consulta de BPe não está disponível na SEFAZ {$this->config->siglaUF}!!!";
